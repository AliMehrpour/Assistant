...
public final class AssistantContract {
    ...
    public static final String CONTENT_AUTHORITY = "com.volcano.assistant";
    public static final Uri BASE_CONTENT_URI = Uri.parse("content://" + CONTENT_AUTHORITY);
    public static final String BASE_CONTENT_TYPE = "vnd.android.cursor.dir/vnd.assistant.";
    public static final String BASE_CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.assistant.";
